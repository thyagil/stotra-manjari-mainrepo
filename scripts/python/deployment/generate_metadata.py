...
def generate_chapter_metadata(csv_file, project_id, volume_id, output_root, overwrite=False):
    ...
    volume_metadata = {
        "id": volume_id,
        "title": f"Volume {int(volume_id.replace('volume', '')):02d}",
        "index": int(volume_id.replace("volume", "")),
...
if __name__ == "__main__":
    root = "/Volumes/MyData/stotra_manjari/assets/projects/"
    csv_file = f"{root}ramayanam_sriramghanapatigal/metadata/volume01.csv"
